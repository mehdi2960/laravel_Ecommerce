    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false">
                <span class="ml-2 d-none d-lg-inline text-gray-600 small">{{auth()->user()->name==null ? 'کاربر گرامی':auth()->user()->name}}</span>
            </a>
...
{{--                </a>--}}
                ...
                <a class="dropdown-item" href="{{route('home.users_profile.logoutForm')}}" data-toggle="modal" data-target="#logoutModal">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
               شما مایل به خروج هستید؟
            </div>
            <div class="modal-footer">
                <a class="btn btn-primary" href="{{route('home.users_profile.logoutForm')}}"> خروج </a>
